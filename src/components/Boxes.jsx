...
const Boxes = () => {
    return (
      ...
      <div className="grid h-100 grid-cols-12">
        <div className="bg-[#1030FF] flex items-center pr-16 pl-[17%] col-span-12 lg:col-span-6">
          <BoxText
        ...
        <div className="bg-gray-900 flex items-center pl-16 pr-[17%] col-span-12 lg:col-span-6">
          <BoxText
      ...
      <div className="grid h-100 grid-cols-12">
        <div className="bg-gray-900 flex items-center pr-16 pl-[17%] col-span-12 lg:col-span-6">
          <BoxText
        ...
        <div className="bg-[#1030FF] flex items-center pl-16 pr-[17%] col-span-12 lg:col-span-6">
          <BoxText
